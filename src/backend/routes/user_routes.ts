...
import { registerUser, loginUser, getCurrentUser, getUserById, getUserPosts, getUserComments, updateUserProfile, getAllUsers, getAllComments, getAllPosts } from '../controllers/user_controller';
